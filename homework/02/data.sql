-- Chèn 10 bản ghi Users mẫu với tên và Gmail khác nhau và avatar từ hai đường dẫn ảnh
INSERT INTO Users (firstname, lastname, email, avatar, username, password, address, phone, roleid, status)
VALUES
    (N'Hung', N'Le', 'hungle@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\b.png', SINGLE_BLOB) AS Picture), 'user1', '12345', N'Địa chỉ 1', '0123456789', 2, 1),
    (N'Hong', N'Nguyen', 'nguyenhong@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\a.png', SINGLE_BLOB) AS Picture), 'user2', '12345', N'Địa chỉ 2', '0123456789', 2, 1),
    (N'Hao', N'Doan', 'HaoDoan@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\b.png', SINGLE_BLOB) AS Picture), 'user3', '12345', N'Địa chỉ 3', '0123456789', 3, 1),
    (N'Kim', N'Nhat', 'NhatKim@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\a.png', SINGLE_BLOB) AS Picture), 'user4', '12345', N'Địa chỉ 4', '0123456789', 3, 1),
    (N'Thien', N'Le', 'LeThien@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\b.png', SINGLE_BLOB) AS Picture), 'user5', '12345', N'Địa chỉ 5', '0123456789', 3, 1),
    (N'Hao', N'Le', 'HaoLe@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\a.png', SINGLE_BLOB) AS Picture), 'user6', '12345', N'Địa chỉ 6', '0123456789', 3, 1),
    (N'Thien', N'Ngan', 'NganThien@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\b.png', SINGLE_BLOB) AS Picture), 'user7', '12345', N'Địa chỉ 7', '0123456789', 3, 1),
    (N'Phap', N'Kieu', 'PhapKieu@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\a.png', SINGLE_BLOB) AS Picture), 'user8', '12345', N'Địa chỉ 8', '0123456789', 3, 1),
    (N'Kha', N'Hoang', 'user9@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\b.png', SINGLE_BLOB) AS Picture), 'user9', '12345', N'Địa chỉ 9', '0123456789', 3, 1),
    (N'Tien', N'Thi', 'TienThi@gmail.com', (SELECT BulkColumn FROM OPENROWSET(BULK 'Z:\Users\a.png', SINGLE_BLOB) AS Picture), 'user10', '12345', N'Địa chỉ 10', '0123456789', 3, 1);
